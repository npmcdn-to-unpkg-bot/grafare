...
System.register(['./dashboard_loaders', 'app/core/core_module', './bundle_loader'], function(exports_1) {
 ...
 .when('/org/process/edit/:processId', {
                           templateUrl: 'public/app/features/org/partials/updateProcess.html',
                           controller: 'OrgEditProcess',
                           controllerAs: 'ctrl',
                           resolve: loadOrgBundle,
                       })
    ...
    .when('/org/maintenance/edit/:Id', {
                templateUrl: 'public/app/features/org/partials/updateMaintenance.html',
                 controller: 'OrgEditMaintenance',
                  controllerAs: 'ctrl',
                  resolve: loadOrgBundle,
                    })
            .when('/org/apikeys', {
